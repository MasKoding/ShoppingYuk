    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mb-3">
                <h1 class="text-warning">Shopping Yuk</h1>
                {{-- <img src="/assets/img/logo-hypermart-main-1.png" alt=""> --}}
                <p class="text-light">Shopping Yuk merupakan platform perbelajaan berbagai fashion kekinian dan memberikan
        ...
        <div class="row mt-5">
            <div class="col text-center">
                <p class="text-light">Copyright &copy; 2023 by <a href="#"
                        class="text-warning text-decoration-none" target="_blank">Dimas Priyandi</a></p>
            </div>
        </div>
    </div>
</footer>
